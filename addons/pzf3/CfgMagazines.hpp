class CfgMagazines
{
	...
	class PZF3_HEAT_DM12A1: RPG32_F
	{
		...
		model = QPATHTOF(data\p3d\mag_pzf3_heat_dm12a1_1rnd.p3d);
		modelSpecial = QPATHTOF(data\p3d\mag_pzf3_heat_dm12a1_1rnd.p3d);
	...
	class PZF3_DM32: PZF3_HEAT_DM12A1
	{
		...
		model = QPATHTOF(data\p3d\mag_pzf3_dm32_1rnd.p3d);
		modelSpecial = QPATHTOF(data\p3d\mag_pzf3_dm32_1rnd.p3d);
	...
	class PZF3_HEAT_DM22: PZF3_HEAT_DM12A1
	{
		...
		model = QPATHTOF(data\p3d\mag_pzf3_heat_dm22_1rnd.p3d);
		modelSpecial = QPATHTOF(data\p3d\mag_pzf3_heat_dm22_1rnd.p3d);
